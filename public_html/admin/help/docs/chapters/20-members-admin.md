...
- **A member who should be there is missing.** Three usual causes: (1) you're an area rep and they're in a different chapter; (2) their status is ARCHIVED — flick the status filter to include archived; (3) the search is matching too strictly — try just their member number or just their email.
