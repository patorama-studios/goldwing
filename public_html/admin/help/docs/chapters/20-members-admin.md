...
On submit you land on the new member's Overview with a confirmation of what was created and which emails went out. For a linked associate the confirmation names the household member ("Linked as an associate of …"), so you can see the link took without hunting for it.
