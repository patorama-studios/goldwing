      ...
      <form class="form-card form-card--wizard" method="post" data-wizard>
        ...
        <div class="checkout-grid">
          <div class="checkout-main">
            ...
            <section class="form-step" data-step data-step-key="full-options" data-title="Full options & details" hidden>
              ...
              <div class="form-section" data-full-options hidden>
                ...
                <div class="option-grid">
                  <label class="option-card option-card--compact">
                    <input type="radio" name="full_magazine_type" value="PRINTED" data-required="true"
                      data-required-when="full">
                    <span class="option-card-body">
                  ...
                  <label class="option-card option-card--compact">
                    <input type="radio" name="full_magazine_type" value="PDF" data-required="true"
                      data-required-when="full">
                    <span class="option-card-body">
                ...
                <label class="form-field">
                  ...
                  <select class="form-select" name="full_period_key" data-required="true" data-required-when="full"
                    data-period-select="full">
              ...
              <div class="form-section">
                ...
                <label class="form-field">
                  ...
                  <input id="apply_address_line1" data-google-autocomplete="address"
                    data-google-autocomplete-city="#apply_city" data-google-autocomplete-state="#apply_state"
                    data-google-autocomplete-postal="#apply_postal" data-google-autocomplete-country="#apply_country"
                    class="form-input" type="text" name="address_line1" data-required="true">
              ...
              <div class="form-section">
                ...
                <p class="form-helper">Select the options that apply to the support you can provide and your privacy
                  preferences.</p>
            ...
            <section class="form-step" data-step data-step-key="associate-question" data-title="Associate question"
              hidden>
              ...
              <div class="form-field">
                ...
                <div class="form-checkboxes">
                  <label class="form-checkbox">
                    <input type="radio" name="associate_add" value="yes" data-required="true"
                      data-required-when="associate">
                    Yes
                  </label>
                  <label class="form-checkbox">
                    <input type="radio" name="associate_add" value="no" data-required="true"
                      data-required-when="associate">
                    No
                  </label>
                </div>
            ...
            <section class="form-step" data-step data-step-key="associate-details" data-title="Associate details" hidden>
              ...
              <label class="form-field">
                ...
                <select class="form-select" name="associate_period_key" data-required="true"
                  data-required-when="associate_yes" data-period-select="associate">
                  <option value="">Select a period</option>
                </select>
              ...
              <div class="form-grid two">
                <label class="form-field">
                  ...
                  <input class="form-input" type="text" name="associate_first_name" data-required="true"
                    data-required-when="associate_yes">
                  <span class="form-helper">First</span>
                </label>
                <label class="form-field">
                  <span class="form-label">Associate Member | Last Name</span>
                  <input class="form-input" type="text" name="associate_last_name" data-required="true"
                    data-required-when="associate_yes">
                  <span class="form-helper">Last</span>
                </label>
              </div>
              ...
              <label class="form-field">
                ...
                <input id="associate_address_line1" data-google-autocomplete="address"
                  data-google-autocomplete-city="#associate_city" data-google-autocomplete-state="#associate_state"
                  data-google-autocomplete-postal="#associate_postal_code"
                  data-google-autocomplete-country="#associate_country" class="form-input" type="text"
                  name="associate_address_line1">
                <span class="form-helper">Address Line 1</span>
              </label>
              <div class="form-grid two">
                <label class="form-field">
              ...
              <div class="form-section">
                ...
                <button class="form-button secondary" type="button" data-add-vehicle="associate">Add another
                  vehicle</button>
              </div>
            ...
            <section class="form-step" data-step data-step-key="summary" data-title="Summary & submit" hidden>
              ...
              <div class="payment-panel stripe-style" data-payment-panel="card" hidden>
                <p id="stripe-payment-note" class="form-helper" hidden>The Stripe Payment Element handles card details
                  securely. Complete it below to pay instantly.</p>
