      ...
      <?php if ($requiresShipping): ?>
        <div class="card">
          ...
          <div class="form-group">
            ...
            <input id="shipping-line1" name="shipping_line1" data-google-autocomplete="address"
              data-google-autocomplete-city="#shipping-city" data-google-autocomplete-state="#shipping-state"
              data-google-autocomplete-postal="#shipping-postal" data-google-autocomplete-country="#shipping-country"
              value="<?= e($address['line1']) ?>">
          </div>
          <div class="form-group">
