        ...
        return [
            'member_set_password' => [
                ...
                'defaults' => [
                    ...
                    'body' => '<p>G\'day {{first_name}},</p><p>Welcome to the Australian Goldwing Association\'s member portal — we\'re thrilled to have you on board with us!</p><p>Before you can log in for the first time, you\'ll need to create your password. Press the button below to get started:</p><p><a href="{{reset_link}}" style="display:inline-block;padding:12px 28px;background:#0055ff;color:#fff;text-decoration:none;border-radius:6px;font-weight:bold;font-size:15px;">Set Your Password</a></p><p style="color:#6b7280;font-size:13px;">Press this button and follow the instructions.</p>',
