        ...
        return [
            'member_set_password' => [
                ...
                'defaults' => [
                    ...
                    'body' => '<p>G\'day,</p><p>Welcome to the Australian Goldwing Association\'s member portal — we\'re thrilled to have you with us!</p><p>Before you can log in for the first time, you\'ll need to create your password. Hit the button below to get started:</p><p><a href="{{reset_link}}" style="display:inline-block;padding:12px 28px;background:#0055ff;color:#fff;text-decoration:none;border-radius:6px;font-weight:bold;font-size:15px;">Set Your Password</a></p><hr style="border:none;border-top:1px solid #e5e7eb;margin:28px 0;"><p><strong>Here\'s what\'s waiting for you inside:</strong></p><p>🏍️ <strong>Your Bikes</strong> — Add your Goldwing(s) to your profile and keep your garage up to date.</p><p>👤 <strong>Your Membership Details</strong> — View and update your personal details, contact info, and membership at any time.</p><p>👫 <strong>Associate Members</strong> — Link and collaborate with your associate member so you\'re both connected to the one membership.</p><p>📖 <strong>Wings Magazine</strong> — Read every issue of our member magazine directly in the portal, anytime you like.</p><p>💳 <strong>Membership Payments</strong> — View your payment history, manage renewals, and keep your membership current — all in one place.</p><p>🛒 <strong>Members Store</strong> — Get access to all of our official AGA merchandise in one place. Browse the full catalogue, manage your orders, and re-order your favourite items in the right size — easy.</p><p>📅 <strong>Events</strong> — See what\'s coming up, from rides to rallies to chapter get-togethers.</p><p>📢 <strong>Notice Board</strong> — Stay in the loop with club news and post your own notices for fellow members to see.</p><p>🤝 <strong>Community</strong> — Connect with members across Australia, share in the camaraderie, and make the most of your Goldwing journey.</p><hr style="border:none;border-top:1px solid #e5e7eb;margin:28px 0;"><p>If you have any trouble getting set up, reach out to us at <a href="mailto:webmaster@goldwing.org.au">webmaster@goldwing.org.au</a> and we\'ll help you out.</p><p>Ride safe,<br><strong>The Australian Goldwing Association Team</strong></p>',
