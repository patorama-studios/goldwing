...
class AuthService
{
    ...
    private static function completeLogin(array $user): void
    {
        ...
        $roleList = $user['roles'] ?? [];
        $actorType = array_intersect($roleList, ['admin', 'webmaster', 'committee', 'treasurer', 'chapter_leader', 'store_manager']) ? 'admin' : 'member';
        ...
        $adminRoles = ['admin', 'webmaster', 'committee', 'treasurer', 'chapter_leader', 'store_manager'];
